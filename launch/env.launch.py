...
def generate_launch_description():
  ...
  description_pkg = get_package_share_directory('lewansoul_xarm')
  xacro_model_name = "xArm.urdf"
  xacro_model_path = os.path.join(description_pkg, 'urdf', xacro_model_name)
